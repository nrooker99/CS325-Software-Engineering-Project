...
namespace CP02
{
    ...
    static class DBMng
    {
        ...
        // I wrote this function specifically for the CashReport class, so just ignore it unless you're sure you need it.
        public static int getTotalNumOfEnrollees()
        {
            int i = 0;
            ...
            MySqlCommand cmd = new MySqlCommand();
            cmd.Connection = mycon;
            string query1 = "select * from primaryEnrollee";
            ...
            mycon.Open();
            cmd.Connection = mycon;
            string query2 = "select * from dependentEnrollee";
        ...
        public static int getIncome()
        {
            ...
            MySqlDataReader rd;
            mycon.Open();
            string query1 = "select amount from bills";
            MySqlCommand cmd = new MySqlCommand();
            cmd.Connection = mycon;
            cmd.CommandText = query1;
            cmd.Prepare();
